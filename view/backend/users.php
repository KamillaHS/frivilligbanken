    ...
    <div id="dashboard">
        ...
        <div id="dashboard-content">
            ...
            <div id="dashboard-section1">
                <p>
                    Her kommer der til at være en liste over brugere med email og knap til manuelt at resette deres password, hvis ikke det virker for dem selv. 
                </p>
            </div>
            ...
            <div id="dashboard-section1" class="flex-box">
                ...
                foreach($getusers as $user) {
                    ...
                    <div id="employee-box">
                        <div id="sponsor-info">
                            <div id="employee-pic" style="background-image: url('<?php echo $user['SponsorPic'] ?>')"></div>
